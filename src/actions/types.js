...
export const CHANGE_URL_QUERY_BUT_NOT_REDUX_STATE = "CHANGE_URL_QUERY_BUT_NOT_REDUX_STATE";
...
export const CHANGE_TABLE_ROWSPERPAGE = "CHANGE_TABLE_ROWSPERPAGE";
export const CHANGE_TABLE_DENSE = "CHANGE_TABLE_DENSE";
export const CHANGE_TABLE_ORDER = "CHANGE_TABLE_ORDER";
export const CHANGE_TABLE_ORDERBY = "CHANGE_TABLE_ORDERBY";

export const HANDSON_UPDATE_DATA = "HANDSON_UPDATE_DATA";
export const HANDSON_UPDATE_READONLY = "HANDSON_UPDATE_READONLY";
